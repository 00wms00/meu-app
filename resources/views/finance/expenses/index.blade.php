                    ...
                    <div class="border-t border-gray-200">
                        ...
                        @foreach($vehicleExpensesDoMes as $vexp)
                            <div class="border-t border-gray-50" x-data="{ open: false }">
                                <div class="px-5 py-3 flex items-center gap-3 hover:bg-purple-50/30 cursor-pointer select-none" @click="open = !open">
                                    ...
                                    <span class="text-sm font-bold tabular-nums text-purple-700 whitespace-nowrap">R$ {{ number_format($vexp['valor'], 2, ',', '.') }}</span>
                                    <span class="text-xs text-gray-300 bg-gray-100 px-2 py-0.5 rounded-full">auto</span>
