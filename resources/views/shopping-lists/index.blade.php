...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
    ...
    <a href="{{ route('shopping-lists.show', $lista) }}" class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 hover:shadow-md transition block">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <a href="{{ route('shopping-lists.show', $lista) }}" class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 hover:shadow-md transition block opacity-75">
        <div class="flex items-center justify-between mb-2">
            <h3 class="font-semibold text-gray-800">{{ $lista->nome }}</h3>
