...
<div class="mb-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-gray-600">{{ $dataInicio }} até {{ $dataFim }}</p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('relatorio.mensal') }}"
               class="inline-flex items-center px-3 py-2 border border-gray-300 text-gray-600 hover:bg-gray-50 text-sm font-semibold rounded-md transition">📅 Mensal</a>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
    <form method="GET" class="flex flex-wrap items-end gap-4">
        ...
        <div class="flex gap-1 flex-wrap">
            <a href="{{ route('relatorio.periodo') }}"
               class="inline-flex items-center px-2 py-1 border border-gray-300 text-gray-600 hover:bg-gray-50 text-xs font-semibold rounded-md transition">Hoje</a>
            <a href="{{ route('relatorio.periodo', ['data_inicio' => now()->subDays(7)->format('Y-m-d'), 'data_fim' => now()->format('Y-m-d')]) }}"
               class="inline-flex items-center px-2 py-1 border border-gray-300 text-gray-600 hover:bg-gray-50 text-xs font-semibold rounded-md transition">7 dias</a>
            <a href="{{ route('relatorio.periodo', ['data_inicio' => now()->subDays(30)->format('Y-m-d'), 'data_fim' => now()->format('Y-m-d')]) }}"
               class="inline-flex items-center px-2 py-1 border border-gray-300 text-gray-600 hover:bg-gray-50 text-xs font-semibold rounded-md transition">30 dias</a>
            <a href="{{ route('relatorio.periodo', ['data_inicio' => now()->startOfMonth()->format('Y-m-d'), 'data_fim' => now()->format('Y-m-d')]) }}"
               class="inline-flex items-center px-2 py-1 border border-gray-300 text-gray-600 hover:bg-gray-50 text-xs font-semibold rounded-md transition">Este mês</a>
        </div>
    </form>
</div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
        <h2 class="text-lg font-semibold text-gray-800">🛒 Produtos — {{ $dataInicio }} até {{ $dataFim }}</h2>
    </div>
